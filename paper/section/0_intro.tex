...
which antivirus engines detected the virus,
when and by whom the file is submitted,
and other userful meatadata.
...
Graziano \textit{et al.}~\cite{neeles} leveraged VirusTotal user ID information to identify malware writers 
