...
\begin{center}
{\Large\bf Evaluating and Predicting Influence across Anti-Virus Engines}
\end{center}
\smallskip
...
%\author{Linhai Song}
%\affiliation{%
%  \institution{ACM member}
%}
%\email{songlinhai0543@gmail.com}
...
\input{section/2_graph}
\input{section/3_model}
\input{section/4_analysis}
\input{section/5_con}
