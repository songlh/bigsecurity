...
Therefore, it is important to study what correlates to detection rate.
In this section, we study the correlation between detection rate and submission file size,
two types of historical submission properties, and the reputation and type of source IDs.

In the next section, we will present our further analysis of what 
and if detection rate
...
\yiying{what do you mean by how malicious a malware is? Do you mean more damage a malware can cause? THis cannot be told by VT data. We need to be very careful about these things, since there will be security experts in the PC, I assume.}
