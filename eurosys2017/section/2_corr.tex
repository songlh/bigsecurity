...
\yiying{is reputation a well-known term? what's the rationale behind defining reputation like the follow? is my explanation above correct? Yes}
...
\yiying{fill this, your original explanation doesn't say why} %it is difficult for source IDs with highest reputation to always submit files detected by all engines. 
