...
\yiying{move existing works on VT to Section 2.1 and just say one sentence here, something like VT hasn't been looked much in the past}
...
We collected 4-month metadata from VirusTotal \yiying{and sampled original submission files?}.
...
With this rich dataset, we conducted an extensive study.
