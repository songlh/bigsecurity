...
There are action logs generated, 
...
{\color{red} We only consider cases of changing from labeling benign to malwares, 
...
{\color{red} If we do not filter these files out, 
all their related actions will be counted as $A_{u}$, 
which contributes denominators in all static models, 
and this will make all learned $p_{u,v}$ unnecessarily small. }
\yiying{say why filter here} 
...
{\color{red} The average number of actions taken by the remaining 59 engines is 190140, which is much larger than 10000. }
\yiying{what's the avg num of actions taken by the remaining 59 engines? we need this number to say 10K is small and insignificant.}
...
We measure the accuracy of the four static models using ROC curves {\color{red}(receiver operating characteristic)}, 
\yiying{what's the full name of ROC?}
...
\yiying{what is hump? what is (0,1)?}
...
\yiying{What does this result mean?}
