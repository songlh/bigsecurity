...
{\color{red}We think that all vendors’ suspicious files actually come from their users, 
or all malicious files encountered by users will eventually come to all anti-virus vendors’ hand. }
