...
Normal users submit suspicious files to \vt\ \yiying{when they do not have any anti-virus software, true?}, 
...
and only XX\% \yiying{fill number here} submissions were labeled as malware by at least half of the engines.
